...
$u = URL::get('a.php', array('action'=>'index'));
is( $u, 'a.php?action=index', "1 param" );

$u = URL::get('a.php', array('action'=>'index', 'empty'=>''));
is( $u , 'a.php?action=index', "empty" );

$u = URL::get('a.php', array('action'=>'index', 'nonempty'=>0));
is( $u, 'a.php?action=index&nonempty=0', "nonempty" );

$u = URL::get('a.php', array('action'=>'index'), array('test'=>1), array('test2'=>2) );
