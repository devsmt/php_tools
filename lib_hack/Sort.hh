...
function sort_assoc<Tk, Tv>( array<Tk, Tv> $array, (function(Tv, Tv): int) $cmp ): array<Tk, Tv> {
    _check_sort(\uasort($array, $cmp), 'uasort');
    return $array;
}
function sort_keys<Tk, Tv>( array<Tk, Tv> $array, ?(function(Tk, Tk): int) $cmp = null ): array<Tk, Tv> {
    if ($cmp !== null) {
...
function sort_pairs<Tk as arraykey, Tv>( array<Tk, Tv> $array, (function((Tk, Tv), (Tk, Tv)): int) $cmp ): array<Tk, Tv> {
...
function sort_nums_assoc<Tk, Tv as num>( array<Tk, Tv> $nums, bool $reverse = false ): array<Tk, Tv> {
    if ($reverse) {
...
function sort_nums_keys<Tk as num, Tv>( array<Tk, Tv> $array, bool $reverse = false ): array<Tk, Tv> {
    if ($reverse) {
...
function sort_strings<T as arraykey>( array<T> $strings, bool $caseInsensitive = false, bool $natural = false, bool $reverse = false ): array<T> {
...
function sort_strings_assoc<Tk, Tv as arraykey>( array<Tk, Tv> $strings, bool $caseInsensitive = false, bool $natural = false, bool $reverse = false ): array<Tk, Tv> {
    $flags = _string_sort_flags($caseInsensitive, $natural);
    if ($reverse) {
...
function sort_strings_keys<Tk as arraykey, Tv>( array<Tk, Tv> $array, bool $caseInsensitive = false, bool $natural = false, bool $reverse = false ): array<Tk, Tv> {
    $flags = _string_sort_flags($caseInsensitive, $natural);
    if ($reverse) {
...
function unique_strings<Tk, Tv as arraykey>( array<Tk, Tv> $array, bool $caseInsensitive = false, bool $natural = false ): array<Tk, Tv> {
        return \array_unique($array, _string_sort_flags($caseInsensitive, $natural));
}
